    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '900px' }}>
      ...
      <div className="glass-panel">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {[
            { name: 'Production Website Consent SDK', access: 'Write-Only', lastUsed: 'Just now', key: 'sk_live_4f8e...a2c1d9', show: showKey1, setShow: setShowKey1, fullKey: 'sk_live_4f8e7b2a91c3d8e5f0a2c1d9' },
            { name: 'AWS Read-Replica Scanner', access: 'Read-Only', lastUsed: '15 mins ago', key: 'sk_scan_7d3f...e18b52', show: showKey2, setShow: setShowKey2, fullKey: 'sk_scan_7d3f9a1c4b2e6d8f5a0e18b52' },
          ].map((apiKey, i) => (
            <div key={i} style={{
